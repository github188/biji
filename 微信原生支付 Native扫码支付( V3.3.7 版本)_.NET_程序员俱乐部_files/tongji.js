...
function lz_main()
{
	...
	var server_time = "1423969421";
	var verify_code = "b91816ce";
	var type        = "0";
...
document.write("<img src=\""+dest+"\" border=\"0\" width=\"1\" height=\"1\" />");
	...
	document.write( "<a href=\"http://"+icon_link_host+"/report.html?unit_id="+unit_id+"\" target=\"_blank\">LinezingStat</a>" );
        ...
        if(url_id>0)
                document.write('<scr'+'ipt src=\'http://js.tongji.linezing.com/985790/'+url_id+'/clickcollect.js\'></scr'+'ipt>');
}
